async function fetchOffersEnviadas() {
    const url = 'http://localhost:3000/ofertas-enviadas';
    try {
    ...
    data.forEach(async offer => {
        ...
        offerItem.innerHTML = `
            <div class"">
                ...
                <div >
                    <a href="./visualizarOfertaEnviada.html?id=${offer.id}">Ver detalles de la oferta</a>
                </div>
            </div>
        `;
